...
# camera object
#camera = cv.VideoCapture(r'./vidd.mp4')
...
with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
            ...
            if ratio > 4.5:
                ...
                if CEF_COUNTER > CLOSED_EYES_FRAME :
                    utils.colorBackgroundText(frame, f'Drowsiness Alert...', FONTS, 1.7, (250, 150),
                                              3, utils.YELLOW, pad_x=4, pad_y=6, )
                    playsound.playsound (r'C:\Users\hp\Desktop\opencv_proj\warning.mp3')
    ...
    #create cmd prompt shell then " myenvi\Scripts\activate  " then "  python drowsiness.py  "

    # ratio in 105 line 5.5 to 4.5
